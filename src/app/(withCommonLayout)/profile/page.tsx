    ...
    <Container>
      <div className="py-12 max-w-4xl mx-auto">
        <Card className="shadow-lg border border-gray-200 rounded-xl overflow-hidden">
          {/* Header */}
          <CardHeader className="relative flex flex-col items-center gap-4 bg-purple-50 p-6">
            <img
              src={`${envConfig.base_Url}${latestAdmission.image}`}
              alt={latestAdmission.candidateName}
              className="object-cover w-32 h-32 rounded-full border-4 border-purple-600 shadow-lg"
            />
            ...
            <Button
              variant="default"
              size="sm"
              className="absolute top-4 right-4 flex items-center gap-1 bg-purple-600 hover:bg-purple-700 text-white"
              onClick={handleEdit}>
              <Edit2 size={16} /> Edit
            </Button>
          </CardHeader>
