    ...
    <nav className="bg-white dark:bg-gray-900 shadow-md fixed w-full z-50">
            ...
            {user ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button className="w-8 h-8 rounded-full bg-purple-700 text-white flex items-center justify-center font-bold">
                    {getUserInitial()}
                  </Button>
                </DropdownMenuTrigger>
      ...
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-gray-900 px-2 pt-2 pb-3 space-y-1 shadow-md">
          <Link
            href="/"
            className="block px-3 py-2 rounded-md text-gray-700 hover:text-purple-700 hover:bg-gray-100">
            Home
          </Link>
          <Link
            href="/colleges"
