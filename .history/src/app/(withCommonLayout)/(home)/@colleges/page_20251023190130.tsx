    ...
    <Container>
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="mb-10 text-3xl sm:text-4xl font-bold text-center text-rose-700">
            Top Colleges
          </h2>
              ...
              <Card
                ...
                <CardFooter className="p-4">
                  <Link
                    ...
                    className="w-full">
                    <Button className="w-full bg-linear-to-r from-rose-600 to-indigo-600 text-white hover:opacity-90">
                      Details
                    </Button>
                  </Link>
                </CardFooter>
          ...
          {/* See More Colleges Button */}
          <div className="mt-8 text-center">
            <Link href="/colleges">
              <Button className="bg-rose-600 text-white hover:bg-rose-700 cursor-pointer px-6 py-2">
                See More Colleges
              </Button>
            </Link>
          </div>
