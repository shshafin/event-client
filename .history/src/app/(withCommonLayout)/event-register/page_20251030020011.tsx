...
import { useRegisterEvent } from "@/hooks/register.hook";
...
const registerSchema = z.object({
  ...
  numberOfTickets: z.number().min(1, "At least 1 ticket required"),
...
export default function EventRegistrationPage({ eventId }: Props) {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-20 mb-24 p-6 bg-white shadow-md rounded-md">
      ...
      <FXForm onSubmit={handleSubmit(onSubmit)}>
        <div className="grid gap-4">
          ...
          {errors.numberOfTickets && (
            <p className="text-red-500">{errors.numberOfTickets.message}</p>
          )}
