    ...
    <nav className="bg-white dark:bg-gray-900 shadow-md fixed w-full z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          {/* Logo */}
          <Link href="/">
            <div className="text-2xl font-bold text-rose-700">College App</div>
          </Link>
            ...
            {user ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button className="w-8 h-8 rounded-full bg-rose-700 text-white flex items-center justify-center font-bold">
                    {getUserInitial()}
                  </Button>
                </DropdownMenuTrigger>
